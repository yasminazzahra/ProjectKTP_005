...
import A.yasmina.project.KTP.exceptions.NonexistentEntityException;
import A.yasmina.project.KTP.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("A.yasmina_project.KTP_jar_0.0.1-SNAPSHOTPU");
