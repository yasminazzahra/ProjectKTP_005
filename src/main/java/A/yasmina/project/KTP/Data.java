...
@NamedQueries({
    ...
    @NamedQuery(name = "Data.findByWarganegaraan", query = "SELECT d FROM Data d WHERE d.warganegaraan = :warganegaraan"),
...
public class Data implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "warganegaraan")
    private String warganegaraan;
    ...
    public Data(Long id, String noktp, String nama, Date tgllahir, String jeniskelamin, String alamat, String agama, String status, String warganegaraan) {
        this.id = id;
        this.noktp = noktp;
        this.nama = nama;
        ...
        this.agama = agama;
        this.status = status;
        this.warganegaraan = warganegaraan;
    }
    ...
    public String getWarganegaraan() {
        return warganegaraan;
    }

    public void setWarganegaraan(String warganegaraan) {
        this.warganegaraan = warganegaraan;
    }
    ...
    public String toString() {
        return "A.yasmina.project.KTP.Data[ id=" + id + " ]";
    }
